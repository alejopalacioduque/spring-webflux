package com.reactor.academic.configuration;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Spring-Webflux",
            "https://www.spring-webflux.com",
			"email@email.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Spring WebFlux Api Documentation",
            "Spring WebFlux Api Documentation", "1.0",
